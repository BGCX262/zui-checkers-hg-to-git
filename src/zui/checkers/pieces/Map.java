...
public class Map {
	...
	public List<List<Piece>> getrDiagonals() {
    	return rDiagonals;
    }

	public void setrDiagonals(List<List<Piece>> rDiagonals) {
    	this.rDiagonals = rDiagonals;
    }

	public List<List<Piece>> getlDiagonals() {
    	return lDiagonals;
    }

	public void setlDiagonals(List<List<Piece>> lDiagonals) {
    	this.lDiagonals = lDiagonals;
    }
